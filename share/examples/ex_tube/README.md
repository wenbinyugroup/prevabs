Simple circular tube example with a single layup.

## Overview

This example has a cross-section of a simple circular shape with
radius $r=10$ m. This cross-section geometry can be defined easily by a
center and a radius. Material properties are given in
{ref}`table_tube_materials`. The layup is defined using the stacking
sequence code $[\pm 45_2/0_2/90]_{2s}$.
