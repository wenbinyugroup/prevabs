Closed box-beam example defined directly in the XML input.

## Overview

```{figure} examplebox0.png
:name: fig_box_draw
:width: 4in
:align: center
...
Cross-sectional properties are given in {ref}`table_box_result` and compared with those in Ref. [YU2012]. The tiny differences are due to different meshes.
