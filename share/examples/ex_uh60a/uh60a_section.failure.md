...
- [error]     fatal exception: homogenization failed: layered offset[main_spar]: failed to tile closed layer 1 after the shared DCEL was already mutated; aborting (a legacy fallback here would corrupt the cross-section mesh)  main.cpp:logFatalWithProgress:723
