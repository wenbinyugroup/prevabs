...
This cross-section geometry can be defined as shown in {numref}`fig_channel0` [CHEN2010].
The isotropic material properties are given in {ref}`table_channel_materials`.
...
- [`channel.xml`](../../../../../share/examples/ex_channel/channel.xml)
...
```{figure} ../../../../../share/examples/ex_channel/channel.png
