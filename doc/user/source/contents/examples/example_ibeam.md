...
The dimensions shown in {numref}`fig_ibeam_draw` are $w_1=2.0$ m, $w_2=3.0$ m, $h=3.0$ m, $t_1=0.11$ m, $t_2=0.065$ m, $t_w=0.08$ m.
Materials and layups are given in {ref}`table_ibeam_materials` and {ref}`table_ibeam_layups`.
...
- [`i_web.xml`](../../../../../share/examples/ex_ibeam/i_web.xml)
- [`materials.xml`](../../../../../share/examples/ex_ibeam/materials.xml)
...
```{figure} ../../../../../share/examples/ex_ibeam/i_web.png
:name: fig_ibeam
:width: 4in
:align: center
